...
public class EBookAptController implements Initializable {
      @FXML
...
//        System.out.println("mouse Clicked");
    ...
    public void bookApts(){
        ...
        String query = "UPDATE EMERGENCY SET DOC_ID = '"+ tfDrId.getText() + "' WHERE PATIENT_ID= '"+ patConstructor.EPAT_USERID + "';";
        executeQuery(query);
